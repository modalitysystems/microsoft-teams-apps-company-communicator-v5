...
[assembly: Microsoft.Azure.Functions.Extensions.DependencyInjection.FunctionsStartup(
    typeof(Microsoft.Teams.Apps.CompanyCommunicator.ReportImage.Func.Startup))]
...
namespace Microsoft.Teams.Apps.CompanyCommunicator.ReportImage.Func
{
    ...
    public class Startup : FunctionsStartup
    {
        ...
        public override void Configure(IFunctionsHostBuilder builder)
        {
            ...
            // Add repositories.
            builder.Services.AddSingleton<IMessageReadReportingRepository, MessageReadReportingRepository>();
        }
    }
}